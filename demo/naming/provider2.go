...
const (
	etcdEndpoints5 = "localhost:23790"       // etcd 服务地址
	serviceKey5    = "/services/my-service/" // 服务前缀
)

func main() {
	// 连接到 etcd
	client, err := clientv3.New(clientv3.Config{
		Endpoints:   []string{etcdEndpoints5},
	...
	if err := serviregisterService2(client, serviceID, address, 5); err != nil {
...
// 注册服务
func serviregisterService2(client *clientv3.Client, serviceID, address string, leaseTTL int64) error {
	// 创建租约
